const Footer = () => {
  return (
    <footer className="bg-blue-200 dark:bg-gray-900 mt-10">
    <div className="container p-10 mx-auto">
        <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    <p className="text-xl text-blue-600 font-extrabold">TasteTracker</p>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© TasteTracker 2024 - All rights reserved</p>
        </div>
    </div>
</footer>
  );
