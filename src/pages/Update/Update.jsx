...
const Update = () => {
  ...
  return (
    ...
    <h2 className="text-3xl font-extrabold text-center mb-10 text-blue-600">Update Food Item</h2>
    <form onSubmit={handleUpdateFood}>
      ...
      <input type="submit" value="Update Food" className="btn btn-block bg-blue-600 text-white mt-16" />
    </form>
  </div>
  );
};
